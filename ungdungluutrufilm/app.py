...
# Định nghĩa cấu trúc dữ liệu trong các bộ phim
...
def search_movie():
    if movies:
        ...
        for idx, movie in enumerate(movies, start=1):
            ...
            print("Không tìm thấy bô phim tên là", movie_name)
    else:
        print("Danh sách phim trống!")
...
# Định nghĩa một dict dùng để lưu các option với hành động
operations = {
    'a': add_movie,
    'l': show_movies,
    's': search_movie,
